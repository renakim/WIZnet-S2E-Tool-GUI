...
class WIZArgParser:
    ...
    def config_arg(self):
        ...
        group.add_argument(
            "--char0", help="Designated character delimiter (00: Not use / Other: Designated character)"
        )
        ...
        group.add_argument(
            "--ka",
            choices=["0", "1"],
            help="Keep-alive packet transmit enable for checking TCP connection established",
        )
        group.add_argument(
            "--ki",
            metavar="number",
        ...
        group.add_argument(
            "--char1", help="Designated character delimiter (00: Not use / Other: Designated character)"
        )
